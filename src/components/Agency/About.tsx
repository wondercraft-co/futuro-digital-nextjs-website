            ...
            <div className="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 lg:gap-4 xl:gap-8">
              <div className="aspect-square overflow-hidden rounded-xl shadow-xl outline outline-1 -outline-offset-1 outline-black/10">
                <Image
                  width={1000}
                  height={1000}
                  alt="Jóvenes latinos colaborando en código"
              ...
              <div className="-mt-8 aspect-square overflow-hidden rounded-xl shadow-xl outline outline-1 -outline-offset-1 outline-black/10 lg:-mt-40">
                <Image
                  width={1000}
                  height={1000}
                  alt="Grupo de estudiantes colaborando en proyectos de programación"
                  src="https://images.unsplash.com/photo-1531482615713-2afd69097998?&auto=format&fit=crop&crop=faces&w=560&h=560&q=90"
                  className="block size-full object-cover"
                />
              </div>
              <div className="hidden aspect-square overflow-hidden rounded-xl shadow-xl outline outline-1 -outline-offset-1 outline-black/10">
                <Image
                  width={1000}
                  height={1000}
                  alt="Equipo diverso trabajando en tecnología"
                  src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?&auto=format&fit=crop&crop=faces&w=560&h=560&q=90"
                  className="block size-full object-cover"
                />
              </div>
              <div className="hidden -mt-8 aspect-square overflow-hidden rounded-xl shadow-xl outline outline-1 -outline-offset-1 outline-black/10 lg:-mt-40">
                <Image
                  width={1000}
                  height={1000}
                  alt="Joven latino revisando código"
                  src="https://images.unsplash.com/photo-1571844307880-751c6d86f3f3?&auto=format&fit=crop&crop=faces&w=560&h=560&q=90"
                  className="block size-full object-cover"
                />
              </div>
            </div>
