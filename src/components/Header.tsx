...
const navigation = [
  { name: "Junior Agency", href: "/" },
  { name: "Estudiar desde cero", href: "/desde-cero" },
    ...
    <>
      ...
      <header className="sticky inset-x-0 top-0 z-50 bg-white border-b border-gray-100">
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-indigo-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <Image
                  ...
                  height={32}
                  width={157}
                  src="/logo-futuro-digital-white.svg"
                  className="h-8 w-auto"
                />
              </a>
              <button
